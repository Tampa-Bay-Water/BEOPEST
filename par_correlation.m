...
%     end
    ...
    ptitle = {['Correlated Parameter for Weight Scheme: '],...
...
% also write output to Excel file
f_xls = [d_save '\corrpairs.xls'];
if ~isempty(par_insens)
  par_tran = {S.Parameter.Transformation}';
  xlswrite(f_xls,[par_insens par_tran(~i_sens)],'Insensitive');  
end
